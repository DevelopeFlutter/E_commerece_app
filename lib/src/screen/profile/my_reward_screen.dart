      ...
      body: Obx(()=> myRewardController.myRewardModel.value.data!=null? Container(
        ...
        child: ListView(
          children: [
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 5.h),
                                Text(myRewardController.myRewardModel.value.data!.reward!.rewards.toString(),
            ...
            ListView.builder(
                shrinkWrap: true,
                itemCount: myRewardController.myRewardModel.value.data!.rewardDetails!.data!.length,
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                Expanded(child: Text(myRewardController.myRewardModel.value.data!.rewardDetails!.data![index].product!.productName.toString(),style: AppThemeData.walletTextStyle_12)),
                              ],
                            ),
                            SizedBox(height: 10.h),
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Text("${AppTags.quantity.tr}: ${myRewardController.myRewardModel.value.data!.rewardDetails!.data![index].productQty}",style: AppThemeData.walletTextStyle_12,),
                                Text("${AppTags.totalRewards.tr}: ${myRewardController.myRewardModel.value.data!.rewardDetails!.data![index].reward}",style: AppThemeData.buttonDltTextStyle_12),
                              ],
                            ),
                          ],
                        ),
