                                    ...
                                    Padding(
                                      ...
                                      child: SizedBox(
                                        ...
                                        child: ListView.builder(
                                          ...
                                          itemCount: _cartController.appliedCouponList.data != null
                                              ? _cartController.appliedCouponList.data!.length
                                              : 0,
                                          itemBuilder: (_, index) {
                                            return Padding(
                                              padding:
                        ...
                        child: Column(
                          children: [
                            ...
                            Padding(
                              ...
                              child: InkWell(
                                onTap: () {
                                  if(LocalDataHelper().getConfigData().data!.appConfig!.disableGuest!&&LocalDataHelper().getUserToken()==null){
