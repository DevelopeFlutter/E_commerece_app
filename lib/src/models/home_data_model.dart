...
class Data {
    ...
    if (sectionType == 'slider') {
      ...
      if (json['custom_products'] != null) {
        ...
        json['custom_products'].forEach((v) {
          customProducts!.add(CustomProduct.fromJson(v));
        });
      }
    }
      ...
      if (json['video_shopping'] != null) {
        ...
        json['video_shopping'].forEach((v) {
          videoShopping!.add(VideoShopping.fromJson(v));
        });
      }
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (videoShopping != null) {
      data['video_shopping'] =
          videoShopping!.map((v) => v.toJson()).toList();
    }
    ...
    if (customProducts != null) {
      data['custom_products'] =
          customProducts!.map((v) => v.toJson()).toList();
    }
